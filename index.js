...
function getRandomFlavors(arr1, arr2, arr3, arr4){
  //Combine all 4 arrs into 1: fullFlavors
  const fullFlavors = arr1.concat(arr2, arr3, arr4);
  const randomFlavor = fullFlavors[Math.floor(Math.random()*fullFlavors.length)];
  return randomFlavor;
}
